        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-8 animate-slide-up leading-tight">
              春节安心回家
              <br />
              <span className="text-gradient-festival mt-2 inline-block">跨境聚聊AI 替你全球接单</span>
            </h1>
            ...
            animationDelay: "0.1s"
              ...
              <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
                ...
                <br />
                春节期间 <span className="text-festival-red font-semibold">立即免费领取，抢占春节商机
让跨境聚聊AI 为你创造 "春节利润"</span>，回家过年也能稳稳赚钱
              </p>
            </div>
          </div>
        </div>
