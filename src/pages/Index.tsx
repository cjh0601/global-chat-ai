  ...
  return <div className="min-h-screen bg-gradient-to-b from-red-50 via-orange-50/50 to-amber-50/30 relative overflow-hidden">
      ...
      <section className="relative pt-28 lg:pt-36 pb-12 lg:pb-16">
        <div className="container mx-auto px-4 relative">
          {/* Luna春节形象 - 左侧 */}
          <motion.div className="hidden lg:block absolute left-4 xl:left-12 top-1/2 -translate-y-1/2 w-40 xl:w-56 z-10" initial={{
          opacity: 0,
          x: -100,
          scale: 0.8
        }} animate={{
          ...
          {/* Luna春节形象 - 右侧 */}
          <motion.div className="hidden lg:block absolute right-4 xl:right-12 top-1/2 -translate-y-1/2 w-40 xl:w-56 z-10" initial={{
          opacity: 0,
          x: 100,
          scale: 0.8
        }} animate={{
          ...
          stiffness: 80
            ...
            <motion.img src={lunaSpringRight} alt="Luna新春形象" className="w-full h-auto drop-shadow-2xl" animate={{
            y: [0, -10, 0],
            rotate: [2, -2, 2]
          }} transition={{
            duration: 2.5,
